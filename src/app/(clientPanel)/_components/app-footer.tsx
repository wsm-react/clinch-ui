...
export default function AppFooter() {
    ...
    return (
        <footer className="bg-slate-200 dark:bg-black">
            <div className="container max-w-screen-2xl space-y-16 py-10 ">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 list-inside space-y-2">
                            {menuLinksData1.map((item, index) => (
                                <li key={index}>
                                    <Link href={item.href} className="text-sm text-gray-300 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                                        {item.label}
                                    </Link>
                                </li>
                            ))}
                ...
                <div className="text-center border-t border-gray-300 dark:border-gray-600 pt-14">
                    <ul className="flex justify-center space-x-5">
                        ...
                        <li>
                            <Link href="https://www.facebook.com/" target="_blank" className="text-gray-300 hover:text-gray-900 dark:hover:text-blue-400 dark:text-gray-400">
                        ...
                        <li>
                            <Link href="https://www.instagram.com/" target="_blank" className="text-gray-300 hover:text-gray-900 dark:hover:text-pink-300 dark:text-gray-400">
                        ...
                        <li>
                            <Link href="https://www.x.com/" target="_blank" className="text-gray-300 hover:text-gray-900 dark:hover:text-blue-400 dark:text-gray-400">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path></svg>
                            </Link>
                        </li>
                        <li>
                            <Link href="https://www.github.com/" target="_blank" className="text-gray-300 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                        ...
                        <li>
                            <Link href="https://www.dribbble.com/" target="_blank" className="text-gray-300 hover:text-gray-900 dark:hover:text-pink-300 dark:text-gray-400">
                    ...
                    <span className="block text-sm mt-5 text-center text-gray-300 dark:text-gray-400">© 2021-2022 sitename. All Rights Reserved.  </span>
                </div>
            </div>
        </footer>
    );
