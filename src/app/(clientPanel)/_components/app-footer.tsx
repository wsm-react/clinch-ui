...
export default function AppFooter() {
    ...
    return (
        <footer className="bg-slate-800 dark:bg-black">
            <div className="container 2xl:max-w-screen-2xl xl:max-w-screen-xl max-w-screen-xl space-y-16 py-20 pb-10">
                ...
                <div className="text-center border-t border-gray-600 pt-14">
                    <ul className="flex justify-center space-x-5">
                        ...
                        <li>
                            <Link href="https://www.github.com/" target="_blank" className=" hover:text-white text-gray-400">
                        ...
                        <li>
                            <Link href="https://www.dribbble.com/" target="_blank" className=" hover:text-pink-300 text-gray-400">
                    ...
                    <span className="block text-sm mt-5 text-center text-gray-300 text-gray-400">© 2021-2022 sitename. All Rights Reserved.  </span>
                </div>
            </div>
        </footer>
    );
