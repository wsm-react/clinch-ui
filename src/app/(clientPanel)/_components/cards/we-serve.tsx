...
const CardWeServe: React.FC<WeServeProps> = (cardProps) => {
    return (
        ...
        <div>
            <div className='border border-gray-200 dark:border-cyan-800 p-8 sm:p-10 rounded-xl bg-white dark:bg-white/[.02] relative'>
                <div className="text-[2.3rem]/[2.5rem] sm:text-[1.6rem] md:text-[1rem] lg:text-[1.7rem] xl:text-[2rem] 2xl:text-[2.6rem] font-bold mb-16 sm:mb-6 lg:mb-14">{cardProps.title}</div>
