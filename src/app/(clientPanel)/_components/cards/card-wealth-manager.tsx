...
const CardWealthManager: React.FC<WealthManagerProps> = (cardProps, props) => {
    return (
        <div className='' {...props}>
            <div className="xl:text-[4.1rem]/[5rem] lg:text-[4rem]/[6rem] md:text-[2.8rem]/[4rem] sm:text-[2.2rem]/[3rem] text-[3rem]/[3.3rem] font-bold mb-14 lg:hidden">{cardProps.title}</div>
