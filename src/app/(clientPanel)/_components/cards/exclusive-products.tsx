            ...
            <div className="flex flex-row gap-[50] justify-between items-center">
                ...
                <div className="basis-[45%] md:basis-[40%] lg:basis-[45%] xl:basis-[50%] 2xl:basis-[43%]">
                    ...
                    {cardProps.linkText && <BorderdLink
                        ...
                        href={cardProps.href}
                        containerClass='flex justify-start align-middle mt-24 max-sm:mt-6'
                        className={'sm:text-[1.2rem] xl:text-[1.4rem] text-[.9rem] font-semibold flex flex-row items-center hover:text-blue-600 dark:hover:text-green-300'}
                        icon={ChevronRight}
