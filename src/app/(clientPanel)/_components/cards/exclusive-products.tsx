        ...
        <div className="mt-48 mb-48" {...props}>
            ...
            <div className="flex flex-row gap-[50] justify-between items-center">
                ...
                <div className="basis-[45%] md:basis-[40%] lg:basis-[45%] xl:basis-[45%] 2xl:basis-[43%]">
                    {cardProps.title && <div className="2xl:text-[4.1rem]/[5rem] xl:text-[3.8rem]/[5rem] lg:text-[3rem]/[3.6rem] md:text-[2.8rem]/[4rem] sm:text-[2.2rem]/[3rem] text-[1.8rem]/[2.6rem] font-bold mb-14 max-lg:hidden">{cardProps.title}</div>}
                    {cardProps.subTitle && <div className="sm:text-[1.3rem] md:text-[1.6rem] text-[1rem]"> <HighlightKeyword text={cardProps.subTitle} keyword={cardProps.keyword} className='text-gray-800 dark:text-white' /> </div>}
