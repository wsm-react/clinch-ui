...
export default function GetStartedPage() {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-661px)] flex-col">
      <GetStartedNavBar />
      <div className="pt-4 md:pt-20 pb-40">
        ...
        <div className="w-11/12 md:w-7/12 mx-auto px-6 mt-10 md:mt-14">
          <div className="flex flex-row items-center justify-between mb-3 md:mb-3 font-semibold">
