    ...
    <div className="relative flex min-h-[calc(100vh-661px)] flex-col">
      ...
      <div className="pt-10 md:pt-20 pb-40">
        <div className="w-11/12 md:w-7/12 mx-auto px-6">
          <div className="xl:text-[2.4rem]/[2.8rem] lg:text-[4rem]/[6rem] md:text-[2.8rem]/[4rem] sm:text-[2.2rem]/[3rem] text-[2rem]/[2.1rem] font-bold md:font-semibold">Let's start right away</div>
